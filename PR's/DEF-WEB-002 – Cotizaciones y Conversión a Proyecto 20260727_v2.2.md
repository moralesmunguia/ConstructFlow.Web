...
# 29. Matriz funcional
  ...
  COT-030   WBS                            TERMINADO básico -- confirmado: `CodigoWBS` se copia sin validar duplicados (bypass de `existeCodigoWBSProyecto`, mismo hallazgo que DEF-WEB-003 PRO-010)
  ...
  COT-033   Dependencias                   PENDIENTE transferencia -- confirmado: no existe código de transferencia de dependencias en `convertirAProyecto()`
